...
<link rel="stylesheet" media="screen,projection" type="text/css" href="<%=basePath%>css/ext-all.css" />
...
<script type="text/javascript" src="<%=basePath%>js/grid-simple-array.js"></script>
